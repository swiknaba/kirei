...
class Kirei::Services::Runner
  class << self
    # source://kirei//lib/kirei/services/runner.rb#54
    sig { type_parameters(:T).params(block: T.proc.returns(T.type_parameter(:T))).returns(::Concurrent::Future) }
    def async(&block); end

    # should we move "async" & "await" into instance methods, so we get the input type?
    #
    # source://kirei//lib/kirei/services/runner.rb#64
    sig { params(future: ::Concurrent::Future).returns(T.untyped) }
    def await(future); end
    ...
    # source://kirei//lib/kirei/services/runner.rb#72

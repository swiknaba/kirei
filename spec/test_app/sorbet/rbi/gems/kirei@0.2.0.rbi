...
# source://kirei//lib/kirei/middleware.rb#4
module Kirei
  class << self
...
# source://kirei//lib/kirei/app.rb#9
class Kirei::App
  include ::Kirei::Middleware

  # source://kirei//lib/kirei/app.rb#14
  sig { params(params: T::Hash[::String, T.untyped]).void }
  def initialize(params: T.unsafe(nil)); end

  # source://kirei//lib/kirei/app.rb#23
  sig do
    params(
  ...
  # source://kirei//lib/kirei/app.rb#20
...
class Kirei::AppBase < ::Kirei::App
  class << self
    # convenience method since "Kirei.configuration" must be nilable since it is nil
    # at the beginning of initilization of the app
    #
    # source://kirei//lib/kirei/app_base.rb#14
    sig { returns(::Kirei::Config) }
    def config; end

    # source://kirei//lib/kirei/app_base.rb#39
    sig { returns(::String) }
    def default_db_name; end

    # source://kirei//lib/kirei/app_base.rb#44
    sig { returns(::String) }
    def default_db_url; end

    # source://kirei//lib/kirei/app_base.rb#34
    sig { returns(::String) }
    def environment; end

    # source://kirei//lib/kirei/app_base.rb#52
    sig { returns(::Sequel::Database) }
    def raw_db_connection; end

    # source://kirei//lib/kirei/app_base.rb#19
    sig { returns(::Pathname) }
    def root; end

    # source://kirei//lib/kirei/app_base.rb#24
    sig { returns(::String) }
    def version; end
  end
end

# source://kirei//lib/kirei/base_controller.rb#7
class Kirei::BaseController < ::Kirei::App; end
...
# source://kirei//lib/kirei/middleware.rb#5
module Kirei::Middleware; end

# source://kirei//lib/kirei/middleware.rb#15
Kirei::Middleware::RackEnvType = T.type_alias { T::Hash[::String, T.any(::IO, ::Numeric, ::Puma::Client, ::Puma::Configuration, ::String, ::StringIO, ::TCPSocket, T::Array[T.untyped], T::Boolean)] }

# https://github.com/rack/rack/blob/main/UPGRADE-GUIDE.md#rack-3-upgrade-guide
#
# source://kirei//lib/kirei/middleware.rb#7
Kirei::Middleware::RackResponseType = T.type_alias { [::Integer, T::Hash[::String, ::String], T.any(::Proc, T::Array[::String])] }

# we don't know what Oj does under the hood with the options hash, so don't freeze it
#
# source://kirei//lib/kirei.rb#11
...
# ])
#
# source://kirei//lib/kirei/router.rb#19
class Kirei::Router
  include ::Singleton
  extend ::Singleton::SingletonClassMethods

  # source://kirei//lib/kirei/router.rb#35
  sig { void }
  def initialize; end

  # source://kirei//lib/kirei/router.rb#48
  sig { params(verb: ::String, path: ::String).returns(T.nilable(::Kirei::Router::Route)) }
  def get(verb, path); end

  # source://kirei//lib/kirei/router.rb#40
  sig { returns(T::Hash[::String, ::Kirei::Router::Route]) }
  def routes; end

  class << self
    # source://kirei//lib/kirei/router.rb#54
    sig { params(routes: T::Array[::Kirei::Router::Route]).void }
...
# source://kirei//lib/kirei/router.rb#23
class Kirei::Router::Route < ::T::Struct
  const :verb, ::String
  const :path, ::String
  const :controller, T.class_of(Kirei::BaseController)
  const :action, ::String
...
# source://kirei//lib/kirei/router.rb#30
Kirei::Router::RoutesHash = T.type_alias { T::Hash[::String, ::Kirei::Router::Route] }

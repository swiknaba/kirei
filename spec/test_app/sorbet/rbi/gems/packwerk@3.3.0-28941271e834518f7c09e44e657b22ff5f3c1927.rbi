...
# source://packwerk//lib/packwerk.rb#15
module Packwerk
...
class Packwerk::ApplicationValidator
  ...
  # source://packwerk//lib/packwerk/application_validator.rb#18
  sig do
    params(
      package_set: Packwerk::PackageSet,
      configuration: ::Packwerk::Configuration
  ...
  # source://packwerk//lib/packwerk/application_validator.rb#73
  ...
  # source://packwerk//lib/packwerk/application_validator.rb#89
  sig { params(configuration: ::Packwerk::Configuration).returns(::Packwerk::Validator::Result) }
  ...
  # source://packwerk//lib/packwerk/application_validator.rb#110
  sig { params(configuration: ::Packwerk::Configuration).returns(::Packwerk::Validator::Result) }
  def check_root_package_exists(configuration); end

  # source://packwerk//lib/packwerk/application_validator.rb#38
  ...
  # source://packwerk//lib/packwerk/application_validator.rb#134
...
class Packwerk::AssociationInspector
  ...
  # source://packwerk//lib/packwerk/association_inspector.rb#17
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/association_inspector.rb#25
  sig do
    override
      .params(
        node: ::AST::Node,
...
class Packwerk::Cache
  ...
  # source://packwerk//lib/packwerk/cache.rb#82
  sig { void }
  def bust_cache!; end

  # source://packwerk//lib/packwerk/cache.rb#142
  sig { params(contents: ::String, contents_key: ::Symbol).void }
  def bust_cache_if_contents_have_changed(contents, contents_key); end

  # source://packwerk//lib/packwerk/cache.rb#137
  sig { void }
  def bust_cache_if_inflections_have_changed!; end

  # source://packwerk//lib/packwerk/cache.rb#130
  sig { void }
  def bust_cache_if_packwerk_yml_has_changed!; end

  # source://packwerk//lib/packwerk/cache.rb#166
  sig { void }
  def create_cache_directory!; end

  # source://packwerk//lib/packwerk/cache.rb#118
  sig { params(file: ::String).returns(::String) }
  def digest_for_file(file); end

  # source://packwerk//lib/packwerk/cache.rb#123
  sig { params(str: ::String).returns(::String) }
  def digest_for_string(str); end

  # source://packwerk//lib/packwerk/cache.rb#87
  sig do
    params(
      file_path: ::String,
...
# source://packwerk//lib/packwerk/cache.rb#8
class Packwerk::Cache::CacheContents
  # source://packwerk//lib/packwerk/cache.rb#16
  ...
  # source://packwerk//lib/packwerk/cache.rb#59
  sig { returns(::String) }
  def serialize; end

  # source://packwerk//lib/packwerk/cache.rb#42
  sig { params(_args: T.untyped).returns(::String) }
  def to_json(*_args); end

  # source://packwerk//lib/packwerk/cache.rb#13
  sig { returns(T::Array[::Packwerk::UnresolvedReference]) }
  def unresolved_references; end

  class << self
    # source://packwerk//lib/packwerk/cache.rb#23
...
# source://packwerk//lib/packwerk/cache.rb#64
...
module Packwerk::Checker
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/checker.rb#62
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/checker.rb#54
...
class Packwerk::Cli
  ...
  # source://packwerk//lib/packwerk/cli.rb#32
  sig { params(args: T::Array[::String]).returns(T::Boolean) }
  def execute_command(args); end

  # source://packwerk//lib/packwerk/cli.rb#26
...
class Packwerk::Commands::BaseCommand
  ...
  # source://packwerk//lib/packwerk/commands/base_command.rb#25
  sig do
    params(
      args: T::Array[::String],
      configuration: ::Packwerk::Configuration,
  ...
  # source://packwerk//lib/packwerk/commands/base_command.rb#41
  sig { returns(T::Array[::String]) }
  def args; end

  # source://packwerk//lib/packwerk/commands/base_command.rb#44
  sig { returns(::Packwerk::Configuration) }
  def configuration; end

  # source://packwerk//lib/packwerk/commands/base_command.rb#50
  sig { returns(T.any(::IO, ::StringIO)) }
  def err_out; end

  # source://packwerk//lib/packwerk/commands/base_command.rb#56
  sig { returns(::Packwerk::OffensesFormatter) }
  def offenses_formatter; end

  # source://packwerk//lib/packwerk/commands/base_command.rb#47
  sig { returns(T.any(::IO, ::StringIO)) }
  def out; end

  # source://packwerk//lib/packwerk/commands/base_command.rb#53
  sig { returns(::Packwerk::Formatters::ProgressFormatter) }
  def progress_formatter; end

  class << self
    # source://packwerk//lib/packwerk/commands/base_command.rb#15
...
class Packwerk::Commands::HelpCommand < ::Packwerk::Commands::BaseCommand
  # source://packwerk//lib/packwerk/commands/help_command.rb#11
  sig { override.returns(T::Boolean) }
  def run; end

  private

  # source://packwerk//lib/packwerk/commands/help_command.rb#25
  sig { returns(::String) }
...
class Packwerk::Commands::InitCommand < ::Packwerk::Commands::BaseCommand
  # source://packwerk//lib/packwerk/commands/init_command.rb#11
  sig { override.returns(T::Boolean) }
  def run; end
end
...
class Packwerk::Commands::LazyLoadedEntry
  # source://packwerk//lib/packwerk/commands/lazy_loaded_entry.rb#11
  sig { params(name: ::String, aliases: T::Array[::String]).void }
  def initialize(name, aliases: T.unsafe(nil)); end

  # source://packwerk//lib/packwerk/commands/lazy_loaded_entry.rb#17
  sig { returns(T.class_of(Packwerk::Commands::BaseCommand)) }
  def command_class; end

  # source://packwerk//lib/packwerk/commands/lazy_loaded_entry.rb#23
  sig { returns(::String) }
  def description; end

  # source://packwerk//lib/packwerk/commands/lazy_loaded_entry.rb#28
  sig { params(name_or_alias: ::String).returns(T::Boolean) }
  def matches_command?(name_or_alias); end

  # source://packwerk//lib/packwerk/commands/lazy_loaded_entry.rb#8
  sig { returns(::String) }
  def name; end
end
...
module Packwerk::Commands::UsesParseRun
  ...
  # source://packwerk//lib/packwerk/commands/uses_parse_run.rb#14
  sig do
    params(
      args: T::Array[::String],
      configuration: ::Packwerk::Configuration,
  ...
  # source://packwerk//lib/packwerk/commands/uses_parse_run.rb#33
  sig { returns(T.nilable(::Packwerk::OffensesFormatter)) }
  def offenses_formatter_from_options; end

  # source://packwerk//lib/packwerk/commands/uses_parse_run.rb#38
  sig { returns(::Packwerk::ParseRun) }
  def parse_run; end

  # source://packwerk//lib/packwerk/commands/uses_parse_run.rb#46
...
class Packwerk::Commands::ValidateCommand < ::Packwerk::Commands::BaseCommand
  # source://packwerk//lib/packwerk/commands/validate_command.rb#11
  sig { override.returns(T::Boolean) }
  def run; end

  private

  # source://packwerk//lib/packwerk/commands/validate_command.rb#37
  sig { returns(Packwerk::PackageSet) }
  def package_set; end

  # source://packwerk//lib/packwerk/commands/validate_command.rb#32
...
class Packwerk::Commands::VersionCommand < ::Packwerk::Commands::BaseCommand
  # source://packwerk//lib/packwerk/commands/version_command.rb#11
  sig { override.returns(T::Boolean) }
  def run; end
end
...
class Packwerk::Configuration
  # source://packwerk//lib/packwerk/configuration.rb#66
  ...
  # source://packwerk//lib/packwerk/configuration.rb#54
  sig { returns(T::Array[::String]) }
  def associations_exclude; end

  # source://packwerk//lib/packwerk/configuration.rb#60
  sig { returns(::Pathname) }
  def cache_directory; end

  # source://packwerk//lib/packwerk/configuration.rb#105
  sig { returns(T::Boolean) }
  def cache_enabled?; end

  # source://packwerk//lib/packwerk/configuration.rb#57
  sig { returns(T.nilable(::String)) }
  def config_path; end

  # source://packwerk//lib/packwerk/configuration.rb#51
  ...
  # source://packwerk//lib/packwerk/configuration.rb#90
  ...
  # source://packwerk//lib/packwerk/configuration.rb#48
  ...
  # source://packwerk//lib/packwerk/configuration.rb#95
  sig { returns(T::Boolean) }
  def parallel?; end

  # source://packwerk//lib/packwerk/configuration.rb#45
  sig { returns(::String) }
  def root_path; end

  private

  # source://packwerk//lib/packwerk/configuration.rb#134
  sig { returns(T::Hash[::String, T::Module[T.anything]]) }
  def load_paths_from_config; end

  # source://packwerk//lib/packwerk/configuration.rb#153
  sig { params(raw: T.untyped).returns(T::Array[::String]) }
  def parse_config_load_paths(raw); end

  # source://packwerk//lib/packwerk/configuration.rb#112
  sig { returns(T::Hash[::String, T::Module[T.anything]]) }
  def resolve_load_paths; end

  class << self
    # @raise [ArgumentError]
    #
    # source://packwerk//lib/packwerk/configuration.rb#11
...
class Packwerk::ConstNodeInspector
  ...
  # source://packwerk//lib/packwerk/const_node_inspector.rb#11
  sig do
    override
      .params(
        node: ::AST::Node,
  ...
  # source://packwerk//lib/packwerk/const_node_inspector.rb#39
...
class Packwerk::ConstantDiscovery
  # source://packwerk//lib/packwerk/constant_discovery.rb#21
  ...
  #
  #
  # source://packwerk//lib/packwerk/constant_discovery.rb#45
  sig do
    params(
      const_name: ::String,
  ...
  #
  #
  # source://packwerk//lib/packwerk/constant_discovery.rb#33
...
module Packwerk::ConstantNameInspector
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/constant_name_inspector.rb#15
  sig do
    abstract
      .params(
        node: ::AST::Node,
...
# source://packwerk//lib/packwerk/cache.rb#171
class Packwerk::Debug
  class << self
    # source://packwerk//lib/packwerk/cache.rb#174
...
module Packwerk::ExtensionLoader
  class << self
    # source://packwerk//lib/packwerk/extension_loader.rb#10
...
class Packwerk::FileProcessor
  # source://packwerk//lib/packwerk/file_processor.rb#16
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/file_processor.rb#69
...
# source://packwerk//lib/packwerk/file_processor.rb#22
class Packwerk::FileProcessor::ProcessedFile
  # source://packwerk//lib/packwerk/file_processor.rb#30
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/file_processor.rb#27
  sig { returns(T::Array[::Packwerk::Offense]) }
  def offenses; end

  # source://packwerk//lib/packwerk/file_processor.rb#24
  sig { returns(T::Array[::Packwerk::UnresolvedReference]) }
  def unresolved_references; end
end

# source://packwerk//lib/packwerk/file_processor.rb#8
...
class Packwerk::FilesForProcessing
  # source://packwerk//lib/packwerk/files_for_processing.rb#16
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/files_for_processing.rb#25
  sig { returns(T::Set[::String]) }
  def files; end

  # source://packwerk//lib/packwerk/files_for_processing.rb#30
  sig { returns(T::Boolean) }
  ...
  # source://packwerk//lib/packwerk/files_for_processing.rb#84
  sig { returns(T::Set[::String]) }
  def configured_included_files; end

  # source://packwerk//lib/packwerk/files_for_processing.rb#37
  sig { returns(T::Set[::String]) }
  ...
  # source://packwerk//lib/packwerk/files_for_processing.rb#48
  sig { returns(T::Set[::String]) }
  def specified_files; end

  # source://packwerk//lib/packwerk/files_for_processing.rb#61
  sig { params(relative_file_path: ::String).returns(T::Set[::String]) }
  def specified_included_files(relative_file_path); end

  class << self
    # source://packwerk//lib/packwerk/files_for_processing.rb#10
    sig do
      params(
        relative_file_paths: T::Array[::String],
        configuration: ::Packwerk::Configuration,
...
# source://packwerk//lib/packwerk/files_for_processing.rb#6
Packwerk::FilesForProcessing::RelativeFileSet = T.type_alias { T::Set[::String] }

# source://packwerk//lib/packwerk.rb#45
...
class Packwerk::Formatters::DefaultOffensesFormatter
  ...
  # source://packwerk//lib/packwerk/formatters/default_offenses_formatter.rb#34
  sig { override.returns(::String) }
  def identifier; end

  # source://packwerk//lib/packwerk/formatters/default_offenses_formatter.rb#13
  ...
  # source://packwerk//lib/packwerk/formatters/default_offenses_formatter.rb#40
  ...
  # source://packwerk//lib/packwerk/formatters/default_offenses_formatter.rb#56
  sig { params(offense: ::Packwerk::ReferenceOffense).returns(::String) }
  def format_strict_mode_violation(offense); end

  # source://packwerk//lib/packwerk/formatters/default_offenses_formatter.rb#65
  sig { params(offenses: T::Array[T.nilable(::Packwerk::Offense)]).returns(::String) }
  def offenses_list(offenses); end

  # source://packwerk//lib/packwerk/formatters/default_offenses_formatter.rb#73
  sig { params(offenses: T::Array[T.nilable(::Packwerk::Offense)]).returns(::String) }
  def offenses_summary(offenses); end

  # source://packwerk//lib/packwerk/formatters/default_offenses_formatter.rb#51
...
class Packwerk::Formatters::ProgressFormatter
  # source://packwerk//lib/packwerk/formatters/progress_formatter.rb#10
  ...
  # source://packwerk//lib/packwerk/formatters/progress_formatter.rb#41
  sig { void }
  ...
  # source://packwerk//lib/packwerk/formatters/progress_formatter.rb#16
  sig { params(block: T.proc.void).void }
  def started_validation(&block); end

  private

  # source://packwerk//lib/packwerk/formatters/progress_formatter.rb#60
  sig { params(execution_time: ::Float).void }
  def finished(execution_time); end

  # source://packwerk//lib/packwerk/formatters/progress_formatter.rb#72
  sig { params(target_files: T::Set[::String]).void }
  def start_inspection(target_files); end

  # source://packwerk//lib/packwerk/formatters/progress_formatter.rb#67
  sig { void }
  def start_validation; end
end

# source://packwerk//lib/packwerk.rb#80
...
class Packwerk::Generators::ConfigurationFile
  # source://packwerk//lib/packwerk/generators/configuration_file.rb#19
  sig { params(root: ::String, out: T.any(::IO, ::StringIO)).void }
  def initialize(root:, out: T.unsafe(nil)); end

  # source://packwerk//lib/packwerk/generators/configuration_file.rb#25
  sig { returns(T::Boolean) }
  def generate; end
  ...
  # source://packwerk//lib/packwerk/generators/configuration_file.rb#48
  sig { returns(::String) }
  def template; end

  class << self
    # source://packwerk//lib/packwerk/generators/configuration_file.rb#13
    sig { params(root: ::String, out: T.any(::IO, ::StringIO)).returns(T::Boolean) }
    def generate(root:, out:); end
  end
end

# source://packwerk//lib/packwerk/generators/configuration_file.rb#9
...
class Packwerk::Generators::RootPackage
  ...
  class << self
    # source://packwerk//lib/packwerk/generators/root_package.rb#9
    sig { params(root: ::String, out: T.any(::IO, ::StringIO)).returns(T::Boolean) }
    def generate(root:, out:); end
  end
end
...
class Packwerk::Graph
  ...
  # source://packwerk//lib/packwerk/graph.rb#12
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/graph.rb#16
  def cycles; end

  private

  # source://packwerk//lib/packwerk/graph.rb#31
...
module Packwerk::NodeHelpers
  class << self
    # source://packwerk//lib/packwerk/node_helpers.rb#115
    sig { params(node: ::AST::Node).returns(T::Boolean) }
    def class?(node); end

    # source://packwerk//lib/packwerk/node_helpers.rb#14
    sig { params(class_or_module_node: ::AST::Node).returns(::String) }
    def class_or_module_name(class_or_module_node); end

    # source://packwerk//lib/packwerk/node_helpers.rb#105
    sig { params(node: ::AST::Node).returns(T::Boolean) }
    def constant?(node); end

    # source://packwerk//lib/packwerk/node_helpers.rb#110
    sig { params(node: ::AST::Node).returns(T::Boolean) }
    def constant_assignment?(node); end

    # source://packwerk//lib/packwerk/node_helpers.rb#29
    sig { params(constant_node: ::AST::Node).returns(::String) }
    def constant_name(constant_node); end

    # source://packwerk//lib/packwerk/node_helpers.rb#61
    sig do
      params(
        node: ::AST::Node,
    ...
    # source://packwerk//lib/packwerk/node_helpers.rb#72
...
class Packwerk::NodeProcessor
  # source://packwerk//lib/packwerk/node_processor.rb#8
  ...
  # source://packwerk//lib/packwerk/node_processor.rb#14
  sig do
    params(
...
class Packwerk::NodeProcessorFactory
  ...
  # source://packwerk//lib/packwerk/node_processor_factory.rb#10
  sig { returns(T::Array[::Packwerk::ConstantNameInspector]) }
  def constant_name_inspectors; end

  # source://packwerk//lib/packwerk/node_processor_factory.rb#19
  sig { params(relative_file: ::String, node: ::AST::Node).returns(::Packwerk::NodeProcessor) }
  def for(relative_file:, node:); end

  # source://packwerk//lib/packwerk/node_processor_factory.rb#7
  sig { returns(::String) }
  def root_path; end

  private

  # source://packwerk//lib/packwerk/node_processor_factory.rb#29
...
class Packwerk::NodeVisitor
  # source://packwerk//lib/packwerk/node_visitor.rb#8
  sig { params(node_processor: ::Packwerk::NodeProcessor).void }
  def initialize(node_processor:); end

  # source://packwerk//lib/packwerk/node_visitor.rb#13
  sig do
    params(
      node: ::Parser::AST::Node,
      ancestors: T::Array[::Parser::AST::Node],
...
class Packwerk::Offense
  ...
  # source://packwerk//lib/packwerk/offense.rb#9
  ...
  # source://packwerk//lib/packwerk/offense.rb#25
...
class Packwerk::OffenseCollection
  # source://packwerk//lib/packwerk/offense_collection.rb#9
  ...
  # source://packwerk//lib/packwerk/offense_collection.rb#39
  ...
  # source://packwerk//lib/packwerk/offense_collection.rb#21
  sig { returns(T::Array[::Packwerk::Offense]) }
  def errors; end

  # source://packwerk//lib/packwerk/offense_collection.rb#27
  sig { params(offense: ::Packwerk::Offense).returns(T::Boolean) }
  def listed?(offense); end

  # source://packwerk//lib/packwerk/offense_collection.rb#18
  ...
  # source://packwerk//lib/packwerk/offense_collection.rb#24
  sig { returns(T::Array[::Packwerk::ReferenceOffense]) }
  ...
  # source://packwerk//lib/packwerk/offense_collection.rb#83
  sig { params(offense: ::Packwerk::ReferenceOffense).returns(T::Boolean) }
  ...
  # source://packwerk//lib/packwerk/offense_collection.rb#113
  sig { void }
  ...
  # source://packwerk//lib/packwerk/offense_collection.rb#118
...
module Packwerk::OffensesFormatter
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/offenses_formatter.rb#75
  sig { abstract.returns(::String) }
  def identifier; end
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/offenses_formatter.rb#67
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/offenses_formatter.rb#71
  sig do
    abstract
      .params(
        offense_collection: ::Packwerk::OffenseCollection,
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/offenses_formatter.rb#79
  ...
  class << self
    ...
    # source://packwerk//lib/packwerk/offenses_formatter.rb#30
    sig { params(identifier: ::String).returns(::Packwerk::OffensesFormatter) }
    def find(identifier); end

    # source://packwerk//lib/packwerk/offenses_formatter.rb#19
    sig { params(base: T::Class[T.anything]).void }
    def included(base); end
...
# source://packwerk//lib/packwerk/offenses_formatter.rb#10
...
module Packwerk::OutputStyle
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/output_style.rb#20
  sig { abstract.returns(::String) }
  def error; end
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/output_style.rb#16
  sig { abstract.returns(::String) }
  def filename; end
...
# source://packwerk//lib/packwerk.rb#38
...
class Packwerk::OutputStyles::Coloured
  ...
  # source://packwerk//lib/packwerk/output_styles/coloured.rb#25
  sig { override.returns(::String) }
  def error; end

  # source://packwerk//lib/packwerk/output_styles/coloured.rb#18
  sig { override.returns(::String) }
  def filename; end
...
class Packwerk::OutputStyles::Plain
  ...
  # source://packwerk//lib/packwerk/output_styles/plain.rb#23
  sig { override.returns(::String) }
  def error; end

  # source://packwerk//lib/packwerk/output_styles/plain.rb#17
  sig { override.returns(::String) }
  def filename; end
...
class Packwerk::Package
  ...
  # source://packwerk//lib/packwerk/package.rb#23
  sig { params(name: ::String, config: T.nilable(T::Hash[::String, T.untyped])).void }
  def initialize(name:, config: T.unsafe(nil)); end

  # source://packwerk//lib/packwerk/package.rb#48
  sig { params(other: T.untyped).returns(T.nilable(::Integer)) }
  def <=>(other); end

  # source://packwerk//lib/packwerk/package.rb#20
  sig { returns(T::Hash[T.untyped, T.untyped]) }
  def config; end

  # source://packwerk//lib/packwerk/package.rb#17
  sig { returns(T::Array[::String]) }
  def dependencies; end

  # source://packwerk//lib/packwerk/package.rb#36
  sig { params(package: ::Packwerk::Package).returns(T::Boolean) }
  def dependency?(package); end

  # source://packwerk//lib/packwerk/package.rb#31
  sig { returns(T::Boolean) }
  def enforce_dependencies?; end

  # source://packwerk//lib/packwerk/package.rb#55
  sig { params(other: T.untyped).returns(T::Boolean) }
  def eql?(other); end

  # source://packwerk//lib/packwerk/package.rb#60
  sig { returns(::Integer) }
  def hash; end

  # source://packwerk//lib/packwerk/package.rb#14
  sig { returns(::String) }
  def name; end

  # source://packwerk//lib/packwerk/package.rb#41
  sig { params(path: ::String).returns(T::Boolean) }
  def package_path?(path); end

  # source://packwerk//lib/packwerk/package.rb#70
  sig { returns(T::Boolean) }
  def root?; end

  # source://packwerk//lib/packwerk/package.rb#65
  sig { returns(::String) }
  def to_s; end
end

# source://packwerk//lib/packwerk/package.rb#11
...
class Packwerk::PackageSet
  ...
  class << self
    # source://packwerk//lib/packwerk/package_set.rb#22
    sig do
      params(
        root_path: ::String,
    ...
    # source://packwerk//lib/packwerk/package_set.rb#36
    sig do
      params(
        root_path: ::String,
    ...
    # source://packwerk//lib/packwerk/package_set.rb#53
    sig { params(packages: T::Array[::Packwerk::Package]).void }
    def create_root_package_if_none_in(packages); end

    # source://packwerk//lib/packwerk/package_set.rb#60
...
class Packwerk::PackageTodo
  ...
  # source://packwerk//lib/packwerk/package_todo.rb#34
  ...
  # source://packwerk//lib/packwerk/package_todo.rb#88
  sig { void }
  def delete_if_exists; end

  # source://packwerk//lib/packwerk/package_todo.rb#66
  sig { void }
  def dump; end

  # source://packwerk//lib/packwerk/package_todo.rb#23
  sig { params(reference: ::Packwerk::Reference, violation_type: ::String).returns(T::Boolean) }
  def listed?(reference, violation_type:); end

  # source://packwerk//lib/packwerk/package_todo.rb#49
  sig { params(for_files: T::Set[::String]).returns(T::Boolean) }
  def stale_violations?(for_files); end

  private

  # source://packwerk//lib/packwerk/package_todo.rb#98
  sig { params(package: ::String).returns(T::Array[::String]) }
  def deleted_files_for(package); end

  # source://packwerk//lib/packwerk/package_todo.rb#159
  sig { params(path: ::String).returns(T::Hash[::String, T::Hash[::String, T::Hash[::String, T::Array[::String]]]]) }
  def load_yaml_file(path); end

  # source://packwerk//lib/packwerk/package_todo.rb#95
  sig { returns(T::Hash[::String, T::Hash[::String, T::Hash[::String, T::Array[::String]]]]) }
  def new_entries; end

  # source://packwerk//lib/packwerk/package_todo.rb#154
  sig { returns(T::Hash[::String, T::Hash[::String, T::Hash[::String, T::Array[::String]]]]) }
  def old_entries; end

  # source://packwerk//lib/packwerk/package_todo.rb#124
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/package_todo.rb#141
  sig { returns(T::Hash[::String, T::Hash[::String, T::Hash[::String, T::Array[::String]]]]) }
  def prepare_entries_for_dump; end

  # source://packwerk//lib/packwerk/package_todo.rb#105
  sig do
    params(
      package: ::String,
...
# source://packwerk//lib/packwerk/package_todo.rb#9
...
# source://packwerk//lib/packwerk/package_todo.rb#8
...
class Packwerk::ParseRun
  ...
  # source://packwerk//lib/packwerk/parse_run.rb#17
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/parse_run.rb#32
  sig do
    params(
      run_context: ::Packwerk::RunContext,
      block: T.nilable(T.proc.params(offenses: T::Array[::Packwerk::Offense]).void)
  ...
  # source://packwerk//lib/packwerk/parse_run.rb#45
  sig do
    params(
      on_interrupt: T.nilable(T.proc.void),
...
class Packwerk::ParsedConstantDefinitions
  # source://packwerk//lib/packwerk/parsed_constant_definitions.rb#26
  sig { params(root_node: T.nilable(::AST::Node)).void }
  def initialize(root_node:); end

  # source://packwerk//lib/packwerk/parsed_constant_definitions.rb#33
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/parsed_constant_definitions.rb#65
  sig do
    params(
      constant_name: ::String,
  ...
  # source://packwerk//lib/packwerk/parsed_constant_definitions.rb#45
  ...
  class << self
    ...
    #
    # source://packwerk//lib/packwerk/parsed_constant_definitions.rb#12
...
class Packwerk::Parsers::Erb
  ...
  # source://packwerk//lib/packwerk/parsers/erb.rb#15
  ...
  # @yield [node]
  #
  # source://packwerk//lib/packwerk/parsers/erb.rb#60
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/parsers/erb.rb#43
...
class Packwerk::Parsers::Factory
  ...
  # source://packwerk//lib/packwerk/parsers/factory.rb#23
  sig { void }
  def initialize; end
  ...
  # source://packwerk//lib/packwerk/parsers/factory.rb#30
  ...
  class << self
    ...
    # source://packwerk//lib/packwerk/parsers/factory.rb#9
    def allocate; end
...
# source://packwerk//lib/packwerk/parsers/factory.rb#19
Packwerk::Parsers::Factory::ERB_REGEX = T.let(T.unsafe(nil), Regexp)

# source://packwerk//lib/packwerk/parsers/factory.rb#11
...
class Packwerk::Parsers::ParseError < ::StandardError
  # source://packwerk//lib/packwerk/parsers.rb#18
  sig { params(result: ::Packwerk::Parsers::ParseResult).void }
  def initialize(result); end

  # source://packwerk//lib/packwerk/parsers.rb#15
...
# source://packwerk//lib/packwerk/parsers/ruby.rb#27
class Packwerk::Parsers::Ruby::TolerateInvalidUtf8Builder < ::Prism::Translation::Parser::Builder
  # source://packwerk//lib/packwerk/parsers/ruby.rb#29
...
# source://packwerk//lib/packwerk.rb#89
module Packwerk::ReferenceChecking
  extend ::ActiveSupport::Autoload
end

# source://packwerk//lib/packwerk.rb#94
...
class Packwerk::ReferenceChecking::Checkers::DependencyChecker
  ...
  # source://packwerk//lib/packwerk/reference_checking/checkers/dependency_checker.rb#21
  sig { override.params(reference: ::Packwerk::Reference).returns(T::Boolean) }
  def invalid_reference?(reference); end

  # source://packwerk//lib/packwerk/reference_checking/checkers/dependency_checker.rb#30
  sig { override.params(reference: ::Packwerk::Reference).returns(::String) }
  def message(reference); end

  # source://packwerk//lib/packwerk/reference_checking/checkers/dependency_checker.rb#45
  ...
  # source://packwerk//lib/packwerk/reference_checking/checkers/dependency_checker.rb#53
  sig { params(reference: ::Packwerk::Reference).returns(::String) }
  def standard_help_message(reference); end
end

# source://packwerk//lib/packwerk/reference_checking/checkers/dependency_checker.rb#11
...
class Packwerk::ReferenceChecking::ReferenceChecker
  # source://packwerk//lib/packwerk/reference_checking/reference_checker.rb#8
  sig { params(checkers: T::Array[::Packwerk::Checker]).void }
  def initialize(checkers); end

  # source://packwerk//lib/packwerk/reference_checking/reference_checker.rb#13
...
class Packwerk::ReferenceExtractor
  # source://packwerk//lib/packwerk/reference_extractor.rb#44
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/reference_extractor.rb#55
  sig do
    params(
      node: ::Parser::AST::Node,
      ancestors: T::Array[::Parser::AST::Node],
  ...
  # source://packwerk//lib/packwerk/reference_extractor.rb#82
  sig do
    params(
  ...
  # source://packwerk//lib/packwerk/reference_extractor.rb#115
  sig do
    params(
      constant_name: ::String,
  ...
  # source://packwerk//lib/packwerk/reference_extractor.rb#99
  sig do
    params(
      constant_name: ::String,
      node: ::Parser::AST::Node,
  ...
  class << self
    # source://packwerk//lib/packwerk/reference_extractor.rb#9
    sig do
      params(
        unresolved_references: T::Array[::Packwerk::UnresolvedReference],
...
class Packwerk::ReferenceOffense < ::Packwerk::Offense
  ...
  # source://packwerk//lib/packwerk/reference_offense.rb#8
...
class Packwerk::RunContext
  # source://packwerk//lib/packwerk/run_context.rb#28
  sig do
    params(
      root_path: ::String,
  ...
  # source://packwerk//lib/packwerk/run_context.rb#74
  sig { returns(Packwerk::PackageSet) }
  def package_set; end

  # source://packwerk//lib/packwerk/run_context.rb#61
  sig { params(relative_file: ::String).returns(T::Array[::Packwerk::Offense]) }
  def process_file(relative_file:); end

  private

  # source://packwerk//lib/packwerk/run_context.rb#112
  sig { returns(T::Array[::Packwerk::ConstantNameInspector]) }
  def constant_name_inspectors; end
  ...
  # source://packwerk//lib/packwerk/run_context.rb#86
...
module Packwerk::Validator
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/validator.rb#49
  sig do
    abstract
      .params(
        package_set: Packwerk::PackageSet,
  ...
  # source://packwerk//lib/packwerk/validator.rb#52
  ...
  # @raise [NotImplementedError]
  #
  # source://packwerk//lib/packwerk/validator.rb#45
  sig { abstract.returns(T::Array[::String]) }
  def permitted_keys; end

  # source://packwerk//lib/packwerk/validator.rb#88
  sig { params(configuration: ::Packwerk::Configuration, path: ::String).returns(::Pathname) }
  def relative_path(configuration, path); end

  class << self
    # source://packwerk//lib/packwerk/validator.rb#25
    sig { returns(T::Array[::Packwerk::Validator]) }
    def all; end

    # source://packwerk//lib/packwerk/validator.rb#20
    sig { params(base: T::Class[T.anything]).void }
    def included(base); end

    private

    # source://packwerk//lib/packwerk/validator.rb#33
    sig { void }
    def load_defaults; end

    # source://packwerk//lib/packwerk/validator.rb#38
    sig { returns(T::Array[T::Class[T.anything]]) }
    def validators; end
  end
end
...
class Packwerk::Validator::Result
  # source://packwerk//lib/packwerk/validator/result.rb#14
  sig { params(ok: T::Boolean, error_value: T.nilable(::String)).void }
  def initialize(ok:, error_value: T.unsafe(nil)); end

  # source://packwerk//lib/packwerk/validator/result.rb#11
  sig { returns(T.nilable(::String)) }
  def error_value; end

  # source://packwerk//lib/packwerk/validator/result.rb#8
  sig { returns(T::Boolean) }
  def ok; end

  # source://packwerk//lib/packwerk/validator/result.rb#20
  sig { returns(T::Boolean) }
  def ok?; end
end
...
class Packwerk::Validators::DependencyValidator
  ...
  # source://packwerk//lib/packwerk/validators/dependency_validator.rb#11
  sig do
    override
      .params(
        package_set: Packwerk::PackageSet,
  ...
  # source://packwerk//lib/packwerk/validators/dependency_validator.rb#23
  sig { override.returns(T::Array[::String]) }
  def permitted_keys; end
  ...
  # source://packwerk//lib/packwerk/validators/dependency_validator.rb#33
  sig { params(configuration: ::Packwerk::Configuration).returns(::Packwerk::Validator::Result) }
  def check_package_manifest_syntax(configuration); end

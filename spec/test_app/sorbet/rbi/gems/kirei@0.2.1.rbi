...
# source://kirei//lib/cli/commands/new_app/base_directories.rb#3
module Cli; end

# source://kirei//lib/cli/commands/new_app/base_directories.rb#0
module Cli::Commands; end

# source://kirei//lib/cli/commands/new_app/base_directories.rb#0
module Cli::Commands::NewApp; end

# source://kirei//lib/cli/commands/new_app/base_directories.rb#6
class Cli::Commands::NewApp::BaseDirectories
  class << self
    # source://kirei//lib/cli/commands/new_app/base_directories.rb#7
    def call; end

    # source://kirei//lib/cli/commands/new_app/base_directories.rb#13
    def directories; end
  end
end

# source://kirei//lib/cli/commands/new_app/execute.rb#8
class Cli::Commands::NewApp::Execute
  class << self
    # source://kirei//lib/cli/commands/new_app/execute.rb#9
    def call(app_name:); end
  end
end

# source://kirei//lib/cli/commands/new_app/files/app.rb#0
module Cli::Commands::NewApp::Files; end

# source://kirei//lib/cli/commands/new_app/files/app.rb#7
class Cli::Commands::NewApp::Files::App
  class << self
    # source://kirei//lib/cli/commands/new_app/files/app.rb#8
    def call(app_name); end

    # source://kirei//lib/cli/commands/new_app/files/app.rb#12
    def content(app_name); end
  end
end

# source://kirei//lib/cli/commands/new_app/files/config_ru.rb#7
class Cli::Commands::NewApp::Files::ConfigRu
  class << self
    # source://kirei//lib/cli/commands/new_app/files/config_ru.rb#8
    def call(app_name); end

    # source://kirei//lib/cli/commands/new_app/files/config_ru.rb#12
    def content(app_name); end
  end
end

# source://kirei//lib/cli/commands/new_app/files/db_rake.rb#9
class Cli::Commands::NewApp::Files::DbRake
  class << self
    # source://kirei//lib/cli/commands/new_app/files/db_rake.rb#10
    def call(app_name); end

    # source://kirei//lib/cli/commands/new_app/files/db_rake.rb#16
    def content(app_name, db_name); end
  end
end

# source://kirei//lib/cli/commands/new_app/files/irbrc.rb#7
class Cli::Commands::NewApp::Files::Irbrc
  class << self
    # source://kirei//lib/cli/commands/new_app/files/irbrc.rb#8
    def call; end

    # source://kirei//lib/cli/commands/new_app/files/irbrc.rb#12
    def content; end
  end
end

# source://kirei//lib/cli/commands/new_app/files/rakefile.rb#7
class Cli::Commands::NewApp::Files::Rakefile
  class << self
    # source://kirei//lib/cli/commands/new_app/files/rakefile.rb#8
    def call; end

    # source://kirei//lib/cli/commands/new_app/files/rakefile.rb#12
    def content; end
  end
end

# source://kirei//lib/cli/commands/new_app/files/routes.rb#7
class Cli::Commands::NewApp::Files::Routes
  class << self
    # source://kirei//lib/cli/commands/new_app/files/routes.rb#34
    def base_controller; end

    # source://kirei//lib/cli/commands/new_app/files/routes.rb#8
    def call(app_name); end

    # source://kirei//lib/cli/commands/new_app/files/routes.rb#47
    def health_controller(app_name); end

    # source://kirei//lib/cli/commands/new_app/files/routes.rb#14
    def router; end
  end
end

# source://kirei//lib/cli/commands/new_app/files/sorbet_config.rb#7
class Cli::Commands::NewApp::Files::SorbetConfig
  class << self
    # source://kirei//lib/cli/commands/new_app/files/sorbet_config.rb#11
    sig { void }
    def call; end

    # source://kirei//lib/cli/commands/new_app/files/sorbet_config.rb#16
    sig { returns(::String) }
    def content; end
  end
end

# source://kirei//lib/cli/commands/start.rb#7
class Cli::Commands::Start
  class << self
    # source://kirei//lib/cli/commands/start.rb#11
    sig { params(args: T.untyped).void }
    def call(args); end
  end
end

# source://kirei//lib/kirei.rb#31
module Kirei
  class << self
    # source://kirei//lib/kirei.rb#54
...
class Kirei::Routing::Base
  ...
  #
  # source://kirei//lib/kirei/routing/base.rb#69
  sig do
    params(
      body: ::String,
      status: ::Integer,
...
class Kirei::Routing::BaseController < ::Kirei::Routing::Base; end

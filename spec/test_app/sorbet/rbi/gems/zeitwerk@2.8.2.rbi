...
# source://zeitwerk//lib/zeitwerk/error.rb#24
class Zeitwerk::ConflictingNamespaceDefinitionError < ::Zeitwerk::Error
  # @return [ConflictingNamespaceDefinitionError] a new instance of ConflictingNamespaceDefinitionError
  #
  # source://zeitwerk//lib/zeitwerk/error.rb#26
...
class Zeitwerk::Cref
  ...
  # source://zeitwerk//lib/zeitwerk/cref.rb#71
  def location; end
...
class Zeitwerk::Loader
  ...
  # source://zeitwerk//lib/zeitwerk/loader.rb#382
  def __log; end
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#166
  def __unload; end
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#258
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#130
  def setup; end
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#156
  def unload; end
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#346
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#365
  def unregister; end
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#616
  ...
  # source://zeitwerk//lib/zeitwerk/loader.rb#103
  ...
  # source://zeitwerk//lib/zeitwerk/loader.rb#649
  def raise_if_conflicting_root_dir(root_dir); end

  # source://zeitwerk//lib/zeitwerk/loader.rb#625
  ...
  # source://zeitwerk//lib/zeitwerk/loader.rb#659
  ...
  class << self
    ...
    #
    #
    # source://zeitwerk//lib/zeitwerk/loader.rb#481
    def all_dirs; end
    ...
    #
    #
    # source://zeitwerk//lib/zeitwerk/loader.rb#415
    ...
    #
    #
    # source://zeitwerk//lib/zeitwerk/loader.rb#436
...
module Zeitwerk::Loader::Config
  ...
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#103
  def initialize; end

  # source://zeitwerk//lib/zeitwerk/loader/config.rb#369
  def __collapse?(dir); end

  # source://zeitwerk//lib/zeitwerk/loader/config.rb#374
  ...
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#364
  def __root_dir?(dir); end

  # source://zeitwerk//lib/zeitwerk/loader/config.rb#33
  def __roots; end

  # Configure directories or glob patterns to be collapsed.
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#245
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#186
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#234
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#331
  def log!; end

  # source://zeitwerk//lib/zeitwerk/loader/config.rb#17
  def logger; end
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#284
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#65
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#73
  def collapse_parents; end

  # Absolute paths of files or directories not to be eager loaded.
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#79
  def eager_load_exclusions; end

  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#379
  def excluded_from_eager_load?(abspath); end

  # source://zeitwerk//lib/zeitwerk/loader/config.rb#397
  def expand_glob_patterns(glob_patterns); end

  # source://zeitwerk//lib/zeitwerk/loader/config.rb#392
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#92
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#99
  def on_unload_callbacks; end

  # source://zeitwerk//lib/zeitwerk/loader/config.rb#409
  def recompute_collapse_dirs; end

  # source://zeitwerk//lib/zeitwerk/loader/config.rb#414
  def recompute_collapse_parents; end

  # source://zeitwerk//lib/zeitwerk/loader/config.rb#404
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#32
  def roots; end
end
...
# @private
#
# source://zeitwerk//lib/zeitwerk/loader/constant_path_validator.rb#2
class Zeitwerk::Loader::ConstantPathValidator
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/constant_path_validator.rb#10
...
module Zeitwerk::Loader::EagerLoad
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/eager_load.rb#10
  def eager_load(force: T.unsafe(nil)); end

  # @raise [Zeitwerk::SetupRequired]
  #
  # source://zeitwerk//lib/zeitwerk/loader/eager_load.rb#33
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/eager_load.rb#162
...
class Zeitwerk::Loader::FileSystem
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/file_system.rb#120
  def dir?(path); end
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/file_system.rb#71
  def has_exactly_one_nsfile?(cref, dir); end

  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/file_system.rb#125
  ...
  #
  #
  # source://zeitwerk//lib/zeitwerk/loader/file_system.rb#30
  def ls(dir, collapse: T.unsafe(nil), &block); end

  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/file_system.rb#115
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/file_system.rb#106
  def supported_ftype?(abspath); end

  # source://zeitwerk//lib/zeitwerk/loader/file_system.rb#56
  def walk_up(abspath); end

  private

  # source://zeitwerk//lib/zeitwerk/loader/file_system.rb#198
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/file_system.rb#136
  def has_at_least_one_ruby_file?(dir); end

  # source://zeitwerk//lib/zeitwerk/loader/file_system.rb#151
...
module Zeitwerk::Loader::Helpers
  ...
  # source://zeitwerk//lib/zeitwerk/loader/helpers.rb#5
